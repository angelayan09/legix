...
Impact Score: 
• A score from 1-10 and then either LOW (if 1-3), MEDIUM (if 4-7), or HIGH (if 8-10) in parentheses following the number. Then a colored square emoji (🟥 8-10, 🟧 4-7, 🟨 1-3) based on impact level.
